...
Le test est organisé en **3 parties**, pour une durée totale estimée de **~2 heures** :

1. **Partie 1** : Analyse du besoin et proposition d'architecture (30 min)
2. **Partie 2** : Implémentation ciblée d'un sous-ensemble (50-60 min)
3. **Partie 3** : Débrief rapide et questions (10-20 min)
...
- **1 schéma ou pseudo-schéma texte** (pas besoin de Figma)
- **10-15 lignes d'explication structurée** (pas de blabla marketing)
...
## Partie 2 : Implémentation ciblée (50-60 min)
...
## Partie 3 : Débrief rapide (10-20 min)

Après votre rendu, nous ferons un court échange pour évaluer votre **pédagogie interpersonnelle** et votre **posture de lead**.

Quelques questions que nous pourrions poser :
- "Imagine que tu arrives dans l'équipe. Comment tu présenterais ce module aux autres développeurs pour qu'ils sachent l'utiliser sans t'appeler toutes les 10 minutes ?"
- "Qu'est-ce qui est fragile dans ta solution ? Où tu mettrais des tests en priorité pour sécuriser en prod ?"
- "Comment tu ferais évoluer ce panneau de filtres si demain on devait l'utiliser pour un autre écran que Patients (par exemple 'Prescriptions') ?"
- "Comment tu t'y prends avec quelqu'un de l'équipe qui ne respecte pas le composant commun et réécrit son truc maison ?"
